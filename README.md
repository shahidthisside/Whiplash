...
> This project was built as a hands-on exploration of modern Android media architecture — a real, working Media3 session pipeline, a multi-provider YouTube extraction/fallback system, and a from-scratch "Liquid Glass" design system — rather than a wrapper around an existing SDK.
...
### Design & UX
- A custom "Liquid Glass" design system built on Jetpack Compose + Material 3
...
└── ui/              # Compose screens, ViewModels, and the "Liquid Glass" design system
```
